...
@interface FindPasswordVC ()<UITextFieldDelegate,UINavigationControllerDelegate>{
    UIView *_view;
    CGRect _vFrame;
    UITextField *_sjhField;
    UITextField *_yzmField;
    UITextField *_mmField;
    UITextField *_mmField2;
...
//        UIFont *lpFont = [UIFont boldSystemFontOfSize:16];
        ...
        //找回密码标题
        UIImage *zcTitle =[UIImage imageNamed:@"zhaohuimima.png"];
        ...
        //text
        _mmField2 =[[UITextField alloc]initWithFrame:CGRectMake(diView4.frame.origin.x,
                                                                diView4.frame.origin.y-5,
                                                                diView4.frame.size.width,30)];
        _mmField2.placeholder = @"请确认密码";
        [_mmField2 setKeyboardType:UIKeyboardTypeDefault];
        [_mmField2 setBorderStyle:UITextBorderStyleNone];
        [_mmField2 setAutocapitalizationType:UITextAutocapitalizationTypeNone]; //关闭首字母大写
        [_mmField2 setReturnKeyType:UIReturnKeyDone]; //完成
        [_mmField2 setSecureTextEntry:YES]; //验证
        [_view addSubview:_mmField2];
        ...
        submitV.frame = CGRectMake(kScreen_width/2-45,
                                   _mmField2.frame.origin.y+_mmField2.frame.size.height+10, 90,30);
